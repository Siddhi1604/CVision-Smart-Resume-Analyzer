// Simple Node.js API endpoint for job search
  ...
  try {
    ...
    const mockJobs = [
      ...
      },
      {
        ...
        landing_page: "https://datacorp.com/jobs",
      ...
      },
      {
        ...
        landing_page: "https://productinc.com/careers",
    ...
    // Return the response in the same format as the Python backend
    const response = {
