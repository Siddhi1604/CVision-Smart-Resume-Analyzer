...
const Dashboard = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      const mockResumes = [
        { id: 1, title: 'Software Engineer Resume', jobRole: 'Software Engineer', createdAt: '2024-01-15', updatedAt: '2024-01-20', template: 'Modern', status: 'active' },
        { id: 2, title: 'Data Scientist Resume', jobRole: 'Data Scientist', createdAt: '2024-01-10', updatedAt: '2024-01-18', template: 'Professional', status: 'active' },
        { id: 3, title: 'Frontend Developer Resume', jobRole: 'Frontend Developer', createdAt: '2024-01-05', updatedAt: '2024-01-12', template: 'Creative', status: 'draft' }
      ];
      const mockAnalyses = [
        { id: 1, resumeId: 1, score: 85, atsScore: 88, keywordMatch: 82, formatScore: 90, sectionScore: 87, date: '2024-01-20', recommendations: ['Add more quantifiable achievements','Include relevant certifications','Optimize for ATS keywords'] },
        { id: 2, resumeId: 2, score: 78, atsScore: 75, keywordMatch: 80, formatScore: 85, sectionScore: 72, date: '2024-01-18', recommendations: ['Strengthen summary section','Add more technical skills','Improve experience descriptions'] },
        { id: 3, resumeId: 3, score: 92, atsScore: 95, keywordMatch: 90, formatScore: 88, sectionScore: 94, date: '2024-01-12', recommendations: ['Excellent resume structure','Strong keyword optimization','Consider adding certifications'] }
      ];
      ...
      setStats({ totalResumes, totalAnalyses, averageScore, bestScore, recentActivity: mockAnalyses.slice(0, 3) });
